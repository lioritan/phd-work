...
\begin{equation*}
\begin{split}
\mathcal{L}(\mathcal{Q}_i, D_t)\leq \textcolor{blue}{ E_{P\sim \mathcal{Q}_i} \left [ f_{n\sqrt{m}}(t)\right ]} + \textcolor{red}{\frac{1}{n\beta} KL(\mathcal{Q}_i||\mathcal{P}) +\frac{1}{n\beta}E_{P\sim \mathcal{Q}_i} KL(Q_t||P)} \\+ \frac{1}{n\beta} ln\mathbb{E}_{P\sim \mathcal{P}}\mathbb{E}_{h\sim P}\left [ e^{nM_t} \right ]
\end{split}
\end{equation*}
...
\begin{equation*}
\begin{split}
\mathcal{L}(\mathcal{Q}_j, D_t)\leq E_{P\sim \mathcal{Q}_j} \left [ f_{n\sqrt{m}}(t)\right ] + \frac{1}{n\beta} KL(\mathcal{Q}_j||\mathcal{P}) +\frac{1}{n\beta}E_{P\sim \mathcal{Q}_j} KL(Q_t||P) \\+ \frac{1}{n\beta} ln\mathbb{E}_{P\sim \mathcal{P}}\mathbb{E}_{h\sim P}\left [ e^{nM_t} \right ]
\end{split}
\end{equation*}
...
\begin{equation*}
\begin{split}
\mathcal{L}(\mathcal{Q}_j, D_t)\leq \textcolor{blue}{E_{P\sim \mathcal{Q}_i} \left [ f_{n\sqrt{m}}(t)\right ]} + \textcolor{red}{\frac{1}{n\beta} KL(\mathcal{Q}_j||\mathcal{P}) +\frac{1}{n\beta}E_{P\sim \mathcal{Q}_j} KL(Q_t||P)} \\+ \frac{1}{n\beta} ln\mathbb{E}_{P\sim \mathcal{P}}\mathbb{E}_{h\sim P}\left [ e^{nM_t} \right ]
\end{split}
\end{equation*}
...
\begin{equation*}
\begin{split}
\mathcal{L}(\mathcal{Q}_j, D_t)\leq \textcolor{blue}{E_{P\sim \mathcal{Q}_i} \left [ f_{n\sqrt{m}}(t)\right ]} + \frac{1}{n\beta} ln\mathbb{E}_{P\sim \mathcal{P}}\mathbb{E}_{h\sim P}\left [ e^{nM_t} \right ]\\
+\textcolor{red}{\frac{1}{n\beta} KL(\mathcal{Q}_i||\mathcal{P}) +\frac{1}{n\beta}E_{P\sim \mathcal{Q}_i} KL(Q_t||P) + \frac{1}{n\beta}\Psi(\mathcal{Q},\mathcal{Q}_i,\lambda) }
\end{split}
\end{equation*}
...
+ \frac{1}{n\beta} ln\mathbb{E}_{P\sim \mathcal{P}}\mathbb{E}_{h\sim P}\left [ e^{M_t+K_t} \right ]
\\+
