...
\subsection{Task dependencies - 29.8.21}
...
\subsubsection*{Approach 2 - 24.8.21} \label{section-meta-known}
...
Additionally, we note that we do not need to make assumption \ref{assumption-gibbs} to get this bound, it is only required to obtain an alternative representation of $f_{\gamma}(i)$.
...
\subsection{Task dependencies with multiple tasks - 24.8.21}
...
\subsubsection*{Bounding the mistake gap - 25.8.21}
...
\begin{align*}
\begin{split}
&\mathcal{Q}^{*}_{i}(P)=\frac{\mathcal{P}(P) e^{-\lambda g_i(P)}}{Z_{\lambda}(\mathcal{P}, i)} \\
&g_i(P)=\hat{\mathcal{L}}(Q_i,S_i)+ \frac{1}{n\sqrt{m}}KL(Q_i||P)\\
&Z_{\lambda}(\mathcal{P}, i)=E_{P\sim \mathcal{P}} \left [ e^{-\lambda g_i(P) } \right ]
\end{split}
\end{align*}

From here we will write $\mathcal{Q}_k$ instead of $\mathcal{Q}^{*}_{k}$ for convince. From this result  we can write:

$$KL(\mathcal{Q}_j||\mathcal{P})= KL(\mathcal{Q}_j||\mathcal{Q}_i)+\int ln \left ( \frac{e^{-\lambda g_i(P)}}{Z_{\lambda}(\mathcal{P}, i)}\right )d\mathcal{Q}_j $$

\begin{align*}
\begin{split}
 KL(\mathcal{Q}_j||\mathcal{P})- KL(\mathcal{Q}_i||\mathcal{P})& =KL(\mathcal{Q}_j||\mathcal{Q}_i)+\int ln \left ( \frac{e^{-\lambda g_i(P)}}{Z_{\lambda}(\mathcal{P}, i)}\right )d\mathcal{Q}_j-\int ln \left ( \frac{e^{-\lambda g_i(P)}}{Z_{\lambda}(\mathcal{P}, i)}\right )d\mathcal{Q}_i\\
 &=KL(\mathcal{Q}_j||\mathcal{Q}_i)+\int ln \left ( e^{-\lambda g_i(P)} \right)d\mathcal{Q}_j - lnZ_{\lambda}(\mathcal{P}, i) - \int ln \left ( e^{-\lambda g_i(P)} \right)d\mathcal{Q}_i + lnZ_{\lambda}(\mathcal{P}, i)\\
 &=KL(\mathcal{Q}_j||\mathcal{Q}_i)+\int -\lambda g_i(P) d\mathcal{Q}_j - \int -\lambda g_i(P) d\mathcal{Q}_i
\end{split}
\end{align*}
...
\begin{equation}
\begin{split}
KL(\mathcal{Q}_j||\mathcal{P}) = KL(\mathcal{Q}_i||\mathcal{P}) + KL(\mathcal{Q}_j||\mathcal{Q}_i) +  \int \lambda g_i(P) d\mathcal{Q}_i - \int \lambda g_i(P) d\mathcal{Q}_j
\end{split}
\end{equation}

We also note that by definition and from our assumptions, 

$$  KL(\mathcal{Q}_j||\mathcal{Q}_i) = ln\frac{Z_{\lambda}(\mathcal{P}, i)}{Z_{\lambda}(\mathcal{P}, j)} +  \int \lambda g_i(P) d\mathcal{Q}_j - \int \lambda g_j(P) d\mathcal{Q}_j$$

To get consistent bounds, we note that a choice of  $\lambda=\sqrt{n}$ is a good idea. Writing out $g_i$ gives us:

%%+E_{P\sim \mathcal{Q}_j} KL(Q_j||P)

\begin{align*}
\begin{split}
 KL(\mathcal{Q}_j||\mathcal{P}) = KL(\mathcal{Q}_i||\mathcal{P}) + ln\frac{Z_{\sqrt{n}}(\mathcal{P}, i)}{Z_{\sqrt{n}}(\mathcal{P}, j)} &+\sqrt{n}  \int  \left (\hat{\mathcal{L}}(Q_i,S_i)+ \frac{1}{n\sqrt{m}}KL(Q_i||P)\right ) d\mathcal{Q}_i \\&- \sqrt{n} \int \left (\hat{\mathcal{L}}(Q_j,S_j)+ \frac{1}{n\sqrt{m}}KL(Q_j||P)\right ) d\mathcal{Q}_j
\end{split}
\end{align*}
...
\begin{equation*}
\begin{split}
KL(\mathcal{Q}_j||\mathcal{P}) + E_{\mathcal{Q}_j} KL(Q_j||P)= KL(\mathcal{Q}_i||\mathcal{P})  +  E_{\mathcal{Q}_i} KL(Q_i||P) + \textcolor{blue}{ln\frac{Z_{\sqrt{n}}(\mathcal{P}, i)}{Z_{\sqrt{n}}(\mathcal{P}, j)}} \\
 \textcolor{blue}{+\frac{1-\sqrt{nm}}{\sqrt{nm}} \left ( E_{\mathcal{Q}_i} KL(Q_i||P) - E_{\mathcal{Q}_j} KL(Q_j||P)\right )} \\
\textcolor{blue}{+\sqrt{n} E_{\mathcal{Q}_i} \hat{\mathcal{L}}(Q_i,S_i)
    -\sqrt{n} E_{\mathcal{Q}_j} \hat{\mathcal{L}}(Q_j,S_j)    }
\end{split}
\end{equation*}

The additional penalty from choosing the wrong task is marked in blue, and is multiplied by $\frac{1}{n\sqrt{m}}$ in the bound.

\subsubsection*{Comparison with Rothfuss bound - 25.8.21}
...
& +\textcolor{red}{\frac{1}{n\sqrt{m}} KL(\mathcal{Q}_i||\mathcal{P}) +\frac{1}{n\sqrt{m}}E_{P\sim \mathcal{Q}_i} KL(Q_t||P) + \frac{1}{n\sqrt{m}}\Psi(\mathcal{Q}_j,\mathcal{Q}_i,\sqrt{n}) }
\end{split}
\end{align}

Where \begin{equation*}
 \Psi(\mathcal{Q}_k,\mathcal{Q}_i,\lambda)=\begin{cases}
0 &\mathcal{Q}_k=\mathcal{Q}_i\\
ln\frac{Z_{\sqrt{n}}(\mathcal{P}, i)}{Z_{\sqrt{n}}(\mathcal{P}, j)} 
+\frac{1-\sqrt{nm}}{\sqrt{nm}} \left ( E_{\mathcal{Q}_i} KL(Q_i||P) - E_{\mathcal{Q}_j} KL(Q_j||P)\right )
+\sqrt{n} \left (E_{\mathcal{Q}_i} \hat{\mathcal{L}}(Q_i,S_i)
	-E_{\mathcal{Q}_j} \hat{\mathcal{L}}(Q_j,S_j)\right )  &\text{otherwise}
\end{cases}
\end{equation*}

We note that due to the construction of the bound in \cite{Rothfuss2020}, it takes into consideration only meta-training and does not perform meta-adaptation. We can do the same by using the test data only to select the meta-learner. Doing so would replace all instances of $t$ in equation \ref{eq-new-bound} with $i$, letting us more easily compare the two. Looking at the new bound this way we note that the extra term $\frac{1}{n\sqrt{m}}\Psi(\mathcal{Q}_j, \mathcal{Q}_i, \sqrt{n})$ is the only change from equation \ref{eq-single-bound}.
...
Under both these assumptions, it is possible to show that $a-\frac{b-a}{n}\leq g_k(P) \leq b+\frac{b-a}{n}$.

We can also derive from this that $ln\frac{Z_{\sqrt{n}}(\mathcal{P}, i)}{Z_{\sqrt{n}}(\mathcal{P}, j)} \leq \sqrt{n}(b-a+\frac{2(b-a)}{n})$.

Using these, we can calculate

$$\frac{1}{n\sqrt{m}}\Psi(\mathcal{Q}_j, \mathcal{Q}_i, \sqrt{n})\leq \frac{1}{\sqrt{nm}}(b-a) \frac{1-\sqrt{nm}}{nm\sqrt{n}}\left ( E_{\mathcal{Q}_i} KL(Q_i||P) - E_{\mathcal{Q}_j} KL(Q_j||P) \right ) + \frac{1}{\sqrt{nm}}(b-a+\frac{2(b-a)}{n})$$ 

We can also use these assumptions to show  that $E_{\mathcal{Q}_k} KL(Q_k||P)\leq \sqrt{m} (b-a)$ and therefore: 


$$\frac{1}{n\sqrt{m}}\Psi(\mathcal{Q}_j, \mathcal{Q}_i, \sqrt{n})\leq \frac{2}{\sqrt{nm}}(b-a)+ \frac{\sqrt{nm}-1}{n\sqrt{nm}}(b-a)$$ 

If $n\rightarrow\infty$ it is easy to see that $\frac{1}{n\sqrt{m}}\Psi(\mathcal{Q}_j, \mathcal{Q}_i, \sqrt{n})\rightarrow 0$.

If $m\rightarrow\infty$ we get $\frac{1}{n\sqrt{m}}\Psi(\mathcal{Q}_j, \mathcal{Q}_i, \sqrt{n})\rightarrow \frac{b-a}{n}$.


\subsubsection{Probabilistic approach to bounding $\Psi$ - 29.8.21}

In order to achieve a bound that converges to zero for $\Psi(\mathcal{Q}_j, \mathcal{Q}_i, \sqrt{n})$ as $m\rightarrow\infty$, we must take into account the probability of incorrectly choosing the meta-learner, and calculate $E_{j} \left [\Psi(\mathcal{Q}_j, \mathcal{Q}_i, \sqrt{n}) \right ]$ instead. For now, we only assume that assumption \ref{assumption-multitask} still holds.

We will re-index our losses as $\hat{\mathcal{L}}(\mathcal{Q}_{k_1}, S_t), ..., \hat{\mathcal{L}}(\mathcal{Q}_{k_n}, S_t)$ such that $$E_{S_1, ..., S_n, S_t}\left [\hat{\mathcal{L}}(\mathcal{Q}_{k_1}, S_t)\right ]\leq ... \leq E_{S_1, ..., S_n, S_t}\left [\hat{\mathcal{L}}(\mathcal{Q}_{k_n}, S_t)\right ]$$.

For convenience we will mark $E_{S}\left [ \hat{\mathcal{L}}(\mathcal{Q}_{k_i}, S_t)\right ] = E_{S_1, ..., S_n, S_t}\left [\hat{\mathcal{L}}(\mathcal{Q}_{k_i}, S_t)\right ]$.
We note that since $D_i=D_t$, for the learner we chose under assumption \ref{assumption-gibbs} we have $k_1=i$, and therefore for all $j\neq i$ we have $E_{S}\left [ \hat{\mathcal{L}}(\mathcal{Q}_{i}, S_t)\right ] \leq E_{S}\left [ \hat{\mathcal{L}}(\mathcal{Q}_{j}, S_t)\right ]$.

In order to bound the mistake probability, it is useful for us to define:
$$ \Delta_1=E_{S}\left [ \hat{\mathcal{L}}(\mathcal{Q}_{k_2}, S_t)\right ]-E_{S}\left [ \hat{\mathcal{L}}(\mathcal{Q}_{k_1}, S_t)\right ] \text{and } \Delta_j=E_{S}\left [ \hat{\mathcal{L}}(\mathcal{Q}_{k_j}, S_t)\right ]-E_{S}\left [ \hat{\mathcal{L}}(\mathcal{Q}_{k_{j-1}}, S_t)\right ]$$
...
$$ P(\hat{k}=i) \geq P\left(\hat{\mathcal{L}}(\mathcal{Q}_{k_1}, S_t)\leq E_{S}\left [ \hat{\mathcal{L}}(\mathcal{Q}_{k_1}, S_t)\right ]+\frac{\Delta_1}{2} \text{and } \forall j\neq i \hat{\mathcal{L}}(\mathcal{Q}_{k_j}, S_t)\geq E_{S}\left [ \hat{\mathcal{L}}(\mathcal{Q}_{k_j}, S_t)\right ]-\frac{\Delta_j}{2}\right )$$

Taking the complement for this event, we derive

$$ P(\hat{k}\neq i)=1-P(\hat{k}=i)\leq P\left(\hat{\mathcal{L}}(\mathcal{Q}_{k_1}, S_t)\geq E_{S}\left [ \hat{\mathcal{L}}(\mathcal{Q}_{k_1}, S_t)\right ]+\frac{\Delta_1}{2} \text{or } \exists j\neq i \hat{\mathcal{L}}(\mathcal{Q}_{k_j}, S_t)\leq E_{S}\left [ \hat{\mathcal{L}}(\mathcal{Q}_{k_j}, S_t)\right ]-\frac{\Delta_j}{2}\right )$$

$$ P(\hat{k}\neq i)\leq P\left(\hat{\mathcal{L}}(\mathcal{Q}_{k_1}, S_t)\geq E_{S}\left [ \hat{\mathcal{L}}(\mathcal{Q}_{k_1}, S_t)\right ]+\frac{\Delta_1}{2} \right ) + \sum_{j\neq i} P\left ( \hat{\mathcal{L}}(\mathcal{Q}_{k_j}, S_t)\leq E_{S}\left [ \hat{\mathcal{L}}(\mathcal{Q}_{k_j}, S_t)\right ]-\frac{\Delta_j}{2}\right )$$

We can rephrase this as $$ P(\hat{k}\neq i)\leq P\left(\hat{\mathcal{L}}(\mathcal{Q}_{k_1}, S_t)- E_{S}\left [ \hat{\mathcal{L}}(\mathcal{Q}_{k_1}, S_t)\right ]\geq\frac{\Delta_1}{2} \right ) + \sum_{j\neq i} P\left ( \hat{\mathcal{L}}(\mathcal{Q}_{k_j}, S_t)- E_{S}\left [ \hat{\mathcal{L}}(\mathcal{Q}_{k_j}, S_t)\right ]\leq \frac{\Delta_j}{2}\right )$$

Under assumption \ref{assumption-bounded-loss} we can make use of Hoeffding's inequality, and get:

$$ P(\hat{k}\neq i)\leq 2e^{\frac{-2(m\Delta_1/2)^2}{m(b-a)}} + \sum_{j\neq i} 2e^{\frac{-2(m\Delta_j/2)^2}{m(b-a)}}$$

$$ P(\hat{k}\neq i)\leq \sum_{k} 2e^{\frac{-m\Delta_k^2}{2(b-a)}}$$

Since $\Delta_1 \leq \Delta_k$ for all $k$, we can derive

\begin{align} \label{eq-probabilities}
\begin{split}
P(\hat{k}\neq i) &\leq \sum_{k} 2e^{\frac{-m\Delta_1^2}{2(b-a)}}\\
                 &=2ne^{\frac{-m\Delta_1^2}{2(b-a)}}
\end{split}
\end{align}

We note that as $m\rightarrow\infty$, this term goes to zero \footnote{unless $\Delta_1=0$. If that is the case then $D_{k_2}=D_t$ and therefore $\Psi(\mathcal{Q}_{k_2}, \mathcal{Q}_i, \sqrt{n})=0$}. 
Since for $m\rightarrow\infty$ under assumptions \ref{assumption-gibbs}, \ref{assumption-multitask}, \ref{assumption-bounded-loss}  we have seen that $\frac{1}{n\sqrt{m}}\Psi(\mathcal{Q}_j, \mathcal{Q}_i, \sqrt{n})\rightarrow \frac{b-a}{n}$, we can derive that  $E_{j} \left [\frac{1}{n\sqrt{m}}\Psi(\mathcal{Q}_j, \mathcal{Q}_i, \sqrt{n}) \right ]\rightarrow 0$.
