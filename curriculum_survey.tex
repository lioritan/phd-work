...
\subsection{Using the adaptation data - 28.2.22}
...
If we choose the base learner $Q$ to be the Gibbs learner with parameter $\beta$:
...
\subsection{On the connections between MI, stability and PB - 28.2.22}
\begin{defn}
