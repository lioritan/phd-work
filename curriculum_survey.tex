...
\subsubsection{Weighted average approach - 19.9.21}
...
Assuming $\lambda$ is large, we would like $\mathcal{Q}$ to minimize the variance of $\mathcal{L}(Q_t, D_t)$. \textcolor{red}{stuck.}
...
$$ KL(\mathcal{Q}_{i,t}|| \mathcal{P})  \leq Z^{i,t}_{\lambda} + \sqrt{\frac{\lambda^2}{2m}ln\frac{1}{\delta}} -\lambda E_{\mathcal{Q}_{i,t}} \left [\hat{\mathcal{L}}(Q_i, D_t) \right ]$$
