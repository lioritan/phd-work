...
\subsubsection{Using meta-learners as priors - 6.10.21}
...
Where $\mathcal{Q}_0$ is a data-free meta-learner and $\mathcal{Q}_{gibbs}(S_t)$ is the gibbs meta-learner for $S_t$ with meta-prior $\mathcal{P}$.
