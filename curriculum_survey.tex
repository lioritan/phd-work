...
\subsubsection*{Approach 3 - 4.8.21} \label{section-meta-known}
...
\subsection{Task dependencies with multiple tasks - 8.8.21}
...
For finite $m,n$, we have no real way to compare these since KL-divergence is not a distance metric, and there's no real way of comparing $\hat{\mathcal{L}}(\mathcal{Q}_j, S_j)$ and $\hat{\mathcal{L}}(\mathcal{Q}_i, S_i)$.
