...
Taking this term, we can optimize for a new $\bar{g}$ that is less tight but possibly easier to optimize: \footnote{
	...
	$\bar{g}(P)=\frac{1}{n}\sum_k \hat{\mathcal{L}}(Q_i,S_k)+lnE_{h\sim P}\left [ e^{\hat{\mathcal{L}}(h,S_i)}\right ]+ KL(Q_i||P)$}
...
\begin{equation*}
\begin{split}
\mathcal{L}(\mathcal{Q}, D_i)\leq \frac{1}{n}\sum_k E_{P\sim \mathcal{Q}} \left [ \hat{\mathcal{L}}(Q_i,S_k) -\frac{1}{\gamma}KL(Q_i||Q_k) \right ] +  E_{P\sim \mathcal{Q}}KL(\mathcal{Q}||\mathcal{P}) + KL(Q_i||P) \\  + ln\mathbb{E}_{P\sim \mathcal{P}}\mathbb{E}_{h\sim P}\left [ e^{\mathcal{L}(h,\mathcal{D}_i)- \hat{\mathcal{L}}(h, S_i)} \right ]
...
\begin{equation*}
\begin{split}
\mathcal{L}(\mathcal{Q}, D_i)\leq \frac{1}{n}\sum_k E_{P\sim \mathcal{Q}} \left [ \hat{\mathcal{L}}(Q_i,S_k) -\frac{1}{n\beta}KL(Q_i||Q_k) \right ] + \frac{1}{n\beta} E_{P\sim \mathcal{Q}}KL(\mathcal{Q}||\mathcal{P}) +\frac{1}{n\beta} KL(Q_i||P) \\  + \frac{1}{n\beta} ln\mathbb{E}_{P\sim \mathcal{P}}\mathbb{E}_{h\sim P}\left [ e^{n\beta(\mathcal{L}(h,\mathcal{D}_i)- \hat{\mathcal{L}}(h, S_i))} \right ]
...
\begin{equation*}
\begin{split}
\mathcal{L}(\mathcal{Q}, D_i)\leq \frac{1}{n}\sum_k E_{P\sim \mathcal{Q}} \left [ \hat{\mathcal{L}}(Q_i,S_k) -\frac{1}{n\beta}KL(Q_i||Q_k) \right ] + \frac{1}{n\beta} E_{P\sim \mathcal{Q}}KL(\mathcal{Q}||\mathcal{P}) +\frac{1}{n\beta} KL(Q_i||P) \\+ \frac{1}{n\beta} ln\mathbb{E}_{P\sim \mathcal{P}}\mathbb{E}_{h\sim P}\left [ e^{nM} \right ]
\\ 
