...
\begin{figure}[h]
	...
	\caption{Zero-shot reward for PPO with known goal and a random curriculum. We note that $\pi$ is the easiest task, and $0$/$2\pi$ is the hardest, not including a few outliers.}
\end{figure}
...
\begin{figure}[h]
	...
	\caption{Zero-shot reward for PPO with several curricula.}
\end{figure}
...
For PPO, the only parameter was network size for a fully connected MLP network.
