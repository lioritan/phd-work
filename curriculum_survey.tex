...
\subsubsection*{Approach 3 - 1.8.21}
...
\subsubsection*{Footnote : developing $C(S_i,S_k,P)$ - 1.8.21}
...
$$\frac{1}{n\gamma}\sum_k C(S_i,S_k,P) \leq \frac{1}{n\gamma}ln E_{h\sim P} \left [e^{-\gamma\sum_k \hat{L}(h,S_k)}\right ] - \frac{1}{\gamma}lnE_{h\sim P}\left [ e^{-\gamma\hat{\mathcal{L}}(h,S_i)}\right ]$$
...
$$\frac{1}{n\gamma}\sum_k C(S_i,S_k,P) \leq \frac{1}{n\gamma}ln E_{h\sim P} \left [e^{-\gamma\sum_k 0}\right ] + lnE_{h\sim P}\left [ e^{\hat{\mathcal{L}}(h,S_i)}\right ]=lnE_{h\sim P}\left [ e^{\hat{\mathcal{L}}(h,S_i)}\right ]$$

Taking this term, we can optimize for a new $\bar{g}$ that is less tight but possibly easier to optimize: \footnote{
	An even more extreme term would be 
	$\bar{g}(P)=\frac{1}{n}\sum_k \hat{\mathcal{L}}(Q_i,S_k)+lnE_{h\sim P}\left [ e^{\hat{\mathcal{L}}(h,S_i)}\right ]$}
$$\bar{g}(P)=\frac{1}{n}\sum_k \left (\hat{\mathcal{L}}(Q_i,S_k)-\frac{1}{\gamma}KL(Q_i||Q_k)\right )+lnE_{h\sim P}\left [ e^{\hat{\mathcal{L}}(h,S_i)}\right ]$$ 
...
\subsubsection*{Conclusions from approach 3 - 1.8.21}
...
$$ \mathcal{L}(\mathcal{Q}, D_i)\leq \frac{1}{n}\sum_k E_{P\sim \mathcal{Q}} \left [ \hat{\mathcal{L}}(Q_i,S_k) \right ] +  KL(\mathcal{Q}||\mathcal{P}) - \frac{1}{n\gamma} \sum_k E_{P\sim \mathcal{Q}} \left [ KL(Q_i||Q_k) \right ] + ln\mathbb{E}_{P\sim \mathcal{P}}\mathbb{E}_{h\sim P}\left [ e^{\mathcal{L}(h,\mathcal{D}_i)- \hat{\mathcal{L}}(h, S_i)} \right ]
...
\begin{equation*}
\begin{split}
\mathcal{L}(\mathcal{Q}, \mathcal{T}) \leq \frac{1}{n}\sum_k E_{P\sim \mathcal{Q}} \left [ \hat{\mathcal{L}}(Q_k,S_k) \right ] + (\frac{1}{\lambda}+\frac{1}{n\beta}) KL(\mathcal{Q}||\mathcal{P}) + \frac{1}{n\beta}\sum_k \mathbb{E}_{P\sim \mathcal{Q}} \left [KL(Q_k||P) \right ]\\ 
...
\begin{equation*}
\begin{split}
\mathcal{L}(\mathcal{Q}, D_i)\leq \frac{1}{n}\sum_k E_{P\sim \mathcal{Q}} \left [ \hat{\mathcal{L}}(Q_i,S_k) \right ] +  \frac{1}{n\beta} KL(\mathcal{Q}||\mathcal{P}) - \frac{1}{n^2\beta} \sum_k E_{P\sim \mathcal{Q}} \left [ KL(Q_i||Q_k) \right ] \\+ \frac{1}{n\beta} ln\mathbb{E}_{P\sim \mathcal{P}}\mathbb{E}_{h\sim P}\left [ e^{nM} \right ]
\\ 
...
$\mathcal{L}(\mathcal{Q}, \mathcal{T}) \leq  E_{P\sim \mathcal{Q}}  \left [ \hat{\mathcal{L}}(Q_i,S_i) \right ] + (1+\frac{1}{m})KL(\mathcal{Q}||\mathcal{P}) + \frac{1}{m}\mathbb{E}_{P\sim \mathcal{Q}} \left [KL(Q_k||P)\right ] + \frac{1}{m} ln\mathbb{E}_{P\sim \mathcal{P}}\mathbb{E}_{h\sim P}\left [ e^{M} \right ] + \Upsilon^{\text{\Romannum{2}}}(n)$

Compared to 

$\mathcal{L}(\mathcal{Q}, D_i)\leq E_{P\sim \mathcal{Q}}  \left [ \hat{\mathcal{L}}(Q_i,S_i) \right ] + \frac{1}{m}KL(\mathcal{Q}||\mathcal{P}) + \frac{1}{m} ln\mathbb{E}_{P\sim \mathcal{P}}\mathbb{E}_{h\sim P}\left [ e^{M} \right ] $
...
$\mathcal{L}(\mathcal{Q}, D_i)\leq \frac{1}{n}\sum_k E_{P\sim \mathcal{Q}}  \left [ \hat{\mathcal{L}}(Q_i,S_k) \right ]  + \frac{1}{n^2\sqrt{m}}\sum_k E_{P\sim \mathcal{Q}} \left [C(S_i,S_k,P)\right ] + \frac{1}{n\beta} ln\mathbb{E}_{P\sim \mathcal{P}}\mathbb{E}_{h\sim P}\left [ e^{nM} \right ]$
...
This may be a tighter bound if there are many tasks that are similar (in terms of loss of trained classifiers) to task i. We note here that we completely removed the KL-divergence term here since it is deducted from the bound, despite the fact that it improves the bound.
