...
\subsubsection{Probabilistic approach to bounding $\Psi$ - 5.9.21}
...
$$ P(\hat{k}\neq k_1)\leq 2e^{\frac{-2(m\Delta_1/2)^2}{m(b-a)}} + \sum_{j\neq i} 2e^{\frac{-2(m\Delta_j/2)^2}{m(b-a)}}$$

$$ P(\hat{k}\neq k_1)\leq \sum_{k} 2e^{\frac{-m\Delta_k^2}{2(b-a)}}$$

Since $\Delta_1 \leq \Delta_k$ for all $k$, we can derive

\begin{align} \label{eq-probabilities}
\begin{split}
P(\hat{k}\neq k_1) &\leq \sum_{k} 2e^{\frac{-m\Delta_1^2}{2(b-a)}}\\
                 &=2ne^{\frac{-m\Delta_1^2}{2(b-a)}}
\end{split}
\end{align}

We note that as $m\rightarrow\infty$, this term goes to zero. 
...
In essence, under this optimization scheme the $\frac{1}{n\sqrt{m}}\Psi(\mathcal{Q}_j, \mathcal{Q}_i, \sqrt{n})$ term is not needed.
