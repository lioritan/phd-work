...
Another potential solution to this issue is to split the provided data $S_T$ into disjoint adaptation and evaluation sets, $S_{\mathrm{adapt}}$ and $S_{\mathrm{eval}}$, during the meta-adaptation phase and learn the posterior $Q$ based on the adaptation set $S_{\mathrm{adapt}}$ alone. Since this is already common practice in meta-learning algorithms (e.g.\ sampling different data points for the meta-update step \shortcite{Finn2017}), we chose to do so for our empirical evaluation. %Future work will consider and compare these solutions.
...
\begin{table*}[t]	
	...
	\begin{tabular}{llll}
		...
		%Constant hyper-prior & $2$   & $0.433\pm 0.067 $ & $0.303\pm 0.066 $ \\
		%Adaptive hyper-prior & $2$   & $0.35\pm 0.045 $ & $0.2\pm 0 $ \\
		%\midrule
