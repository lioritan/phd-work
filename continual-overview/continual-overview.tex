...
%TODO: continue this direction, though maybe pick  $\rho=(Q_{s:t},\mathcal{D}_s)$ instead to keep it about forgetting -> measure gap on new data and if prior has some stability trait for future tasks we win!
