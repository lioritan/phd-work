...
\begin{equation} 
\mathbb{E}_{S_t\sim \mathcal{D}_t}\mathcal{L}( \hat{Q}^{\lambda_t}_{s:t},\mathcal{D}_s)\leq \frac{\lambda_t K^2}{8m_t}+\mathbb{E}_{h\sim U}\left [\mathcal{L}(h,\mathcal{D}_s)\right ] + \frac{\log |\mathcal{H}|}{\lambda_t}
\end{equation}
