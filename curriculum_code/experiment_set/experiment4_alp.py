...
from curriculum.teachers.learning_rate_custom_teacher import LearningRateCustomTeacher
...
def measure_difficulty(steps_per_task, tasks, wrapper, easy_task, student_alg="PPO", teacher_alg="random"):
    ...
    elif teacher_alg == "riac":
        teacher = RiacTeacher({"max_region_size": 10,
                               "alp_window_size": 10,
                               "nb_split_attempts": 40,
                               "min_reg_size": 1,
                               "min_dims_range_ratio": 1./60,
                               "discard_ratio": 1./4}, wrapper)
    elif teacher_alg == "alp":
        teacher = LearningRateCustomTeacher({"task_set": [
...
if __name__ == "__main__":
    ...
    measure_difficulty(args.steps, args.tasks,
                       MBPendulumAngleContinuousWrapper(randomize_start=True, goal_in_state=True),
                       easy_params,
