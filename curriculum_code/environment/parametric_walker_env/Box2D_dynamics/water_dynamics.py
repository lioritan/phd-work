...
from environment.parametric_walker_env.utils.custom_user_data import CustomUserDataObjectTypes


class WaterDynamics(object):
    def __init__(self, gravity, drag_mod=0.25, lift_mod=0.25, push_mod=0.05, max_drag=2000, max_lift=500, max_push=50):
            ...
            if has_intersection:
                ...
                for i in range(len(intersection_points)):
                    ...
                    if drag_dot >= 0: # normal points backwards - this is not a leading edge
                        ...
                        # drag_mag = Box2D.b2Min(drag_mag, max_drag)
                        ...
                        # lift_mag = Box2D.b2Min(lift_mag, max_lift)
                    ...
                    for joint in joints_to_check:
                        if joint.lowerLimit < joint.angle < joint.upperLimit:
                            ...
                            if push_dot > 0:
                                ...
                                push_mag =  push_dot * self.push_mod * edge_length * density * vel * vel # Not sure about that
