...
from environment.parametric_walker_env.bodies.walkers.WalkerAbstractBody import WalkerAbstractBody
from environment.parametric_walker_env.utils.custom_user_data import CustomBodyUserData, CustomMotorUserData
...
class SpiderBody(WalkerAbstractBody):
    ...
    def draw(self, world, init_x, init_y, force_to_center):
        ...
        main_body.userData = CustomBodyUserData(True, is_contact_critical=True, name="main_body")
