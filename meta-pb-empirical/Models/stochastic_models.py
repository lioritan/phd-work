...
#  Main function
#  -------------------------------------------------------------------------------------------
def get_model(prm, input_shape, output_dim, model_type='Stochastic'):
    ...
    if model_name == 'FcNet3':
        model = FcNet3(model_type, model_name, linear_layer, conv2d_layer, input_shape, output_dim)

    elif model_name == 'ConvNet3':
        model = ConvNet3(model_type, model_name, linear_layer, conv2d_layer, input_shape, output_dim)
    ...
    #     model = densenet_model(depth=20)
        ...
        model = OmConvNet(model_type, model_name, linear_layer, conv2d_layer, input_shape, output_dim)

    elif model_name == 'OmConvNet_NoBN':
        model = OmConvNet_NoBN(model_type, model_name, linear_layer, conv2d_layer, input_shape, output_dim)

    elif model_name == 'OmConvNet_NoBN_32':
        model = OmConvNet_NoBN(model_type, model_name, linear_layer, conv2d_layer, input_shape, output_dim, filt_size=32)
    elif model_name == 'OmConvNet_NoBN_16':
        model = OmConvNet_NoBN(model_type, model_name, linear_layer, conv2d_layer, input_shape, output_dim, filt_size=16)
    elif model_name == 'OmConvNet_NoBN_elu':
        model = OmConvNet_NoBN_elu(model_type, model_name, linear_layer, conv2d_layer, input_shape, output_dim)
...
class FcNet3(general_model):
    def __init__(self, model_type, model_name, linear_layer, conv2d_layer, input_shape, output_dim):
